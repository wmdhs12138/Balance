            ...
            BalanceTheme(
                ...
                ProvideLocalizedContext(language = uiState.language) {
                    MainScreen(
                        ...
                        onSortingModeChanged = viewModel::setSortingMode,
                        onUpdateProviderOrder = viewModel::updateProviderOrder,
                        onPullRefreshHintShown = viewModel::markPullRefreshHintShown,
